class InformesController < ApplicationController
  ...
  private
    ...
    def informe_params
      params.require(:informe).permit(:jefe, :fecha_visita, :supervisor_id, :company_id, :student_id, :aspectos_monitor, :aspectos_estudiante, :problemas_seguridad, :soluciones_seguridad, :problemas_estudiante, :soluciones_estudiante, :problemas_monitor, :soluciones_monitor, :problemas_puesto, :soluciones_puesto)
    end
end
