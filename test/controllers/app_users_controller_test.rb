...
class AppUsersControllerTest < ActionController::TestCase
  ...
  test "should create app_user" do
    assert_difference('AppUser.count') do
      post :create, app_user: { app_user_type_id: @app_user.app_user_type_id, last_name: @app_user.last_name, login: @app_user.login, name: @app_user.name, password: @app_user.password }
    end
  ...
  test "should update app_user" do
    patch :update, id: @app_user, app_user: { app_user_type_id: @app_user.app_user_type_id, last_name: @app_user.last_name, login: @app_user.login, name: @app_user.name, password: @app_user.password }
    assert_redirected_to app_user_path(assigns(:app_user))
  end
